...
bot = Client(
    "bot",
    bot_token=os.environ.get("6464448395:AAEArzvI8Sbygyptv_IcvvsFB2rJ-oaIbTU"),
    api_id=int(os.environ.get("21080577")),
    api_hash=os.environ.get("23bf3f7e84830378c419effeef1624e3")
)
auth_users = [ int(chat) for chat in os.environ.get("6606206195").split(",") if chat != '']
